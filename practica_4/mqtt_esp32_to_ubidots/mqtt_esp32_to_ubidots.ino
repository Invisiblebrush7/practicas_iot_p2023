...
#define TOKEN "BBFF-v8jOOiuNXLnyLKLajo6YFFBaZHkvYQ" // Ubidots TOKEN ID el mismo que usamos en clase lo sacan de Ubidtos
#define MQTT_CLIENT_NAME "clientIDARG" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "MQTT-esp32" // Nombre del dispositivo a crear
